 ...
 *     수정일         수정자                   수정내용
 *     -------          --------        ---------------------------
 *   2016.02.15    abskim               최초 생성
 *
 * @author 공통 서비스 개발팀 abskim
 * @since 2016.02.15
 * @version 1.0
 * @see 
 * 
...
public class CommonSessionCookie {
     ...
     * @throws Exception
     */
    public static void setSessionAttribute(HttpSession session, String keyStr, String valStr) throws Exception {
    	session.setAttribute(keyStr, valStr);
    }    
     ...
     * @throws Exception
     */
    public static Object getSessionAttribute(HttpSession session, String keyStr) throws Exception {
    	return session.getAttribute(keyStr);
    }    
