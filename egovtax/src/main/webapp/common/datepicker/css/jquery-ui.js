...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ..., Sat = 6
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (dow = 0; dow < 7; dow++) { // create date picker days
						// (2016-06-17) 추가
						if( dow === 0 ) dayStyleFont = "style='color:red;font-weight:bold;'";
						else if( dow === 6 ) dayStyleFont = "style='color:blue;font-weight:bold;'";
						else dayStyleFont = "style='font-weight:bold;'";
						...
						tbody += "<td class='" +
							...
							(unselectable ? "<span class='ui-state-default'>" + printDate.getDate() + "</span>" : "<a "+dayStyleFont+" class='ui-state-default" + // 2016-06-17 dayStyleFont 추가
