...
if(detectmob()){
document.write("<script type='text/javascript' charset='utf-8' src='../../common/js/jquery.mobile-1.4.5.min.js'></script>");
}else{
...
document.write("<script type='text/javascript' charset='utf-8' src='../../common/js/ibleaders.js'></script>");