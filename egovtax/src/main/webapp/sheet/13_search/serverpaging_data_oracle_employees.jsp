...
query ="SELECT RN,TO_CHAR(FROM_DATE,'YYYYMMDD') FROM_DATE,TO_CHAR(TO_DATE,'YYYYMMDD') TO_DATE,EMP_NO , TO_CHAR(BIRTH_DATE,'YYYYMMDD') BIRTH_DATE, FIRST_NAME,LAST_NAME, GENDER, TO_CHAR(HIRE_DATE,'YYYYMMDD') HIRE_DATE,DEPT_NO,DEPT_NAME"
+" FROM ("
