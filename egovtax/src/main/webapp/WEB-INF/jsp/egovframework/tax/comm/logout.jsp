		...
		<div class="login_input">
			<form name="loginForm" action="/mis/loginCheck.do" method="post" onsubmit="return fn_login_user('loginForm')">
		  	<table width="255px;" height="60px" border="0" cellpadding="0" cellspacing="0">
		    	<tr>
		      		<td width="130px" height="24px"><input type="text" value="" name="USER_ID" id="input_id" class="normal" style="width:140px;"/></td>
		      		<td width="88px" rowspan="2" style="padding-top: 3px;"><input type="image" src="/image/login_btn.gif" style="cursor: hand;"></td>
		    	</tr>
		    	<tr>
		      		<td height="12"><input type="password" value="" name="USER_PASSWORD" id="input_pw" class="normal" style="width:140px;"/></td>
		      	</tr>
		  	</table>
		  	</form>
		</div>
